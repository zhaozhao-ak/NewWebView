...
import com.rjyx.webviewdemo.jsbridge.Message;
import com.rjyx.webviewdemo.jsbridge.WebViewJavascriptBridge;
import com.rjyx.webviewdemo.x5.X5BridgeUtil;
...
import com.rjyx.webviewdemo.x5.X5WebCacheManager;
...
public class X5BridgeWebView extends X5WebView implements WebViewJavascriptBridge {
    ...
    private BridgeWebView.OnScrollChangedCallback mOnScrollChangedCallback;
    ...
    private void init() {
		 ...
		 */
        this.setWebViewClient(new X5BridgeWebView.X5BridgeWebViewClient());
    }
    ...
    class X5BridgeWebViewClient extends WebViewClient {
        ...
        public void onPageFinished(WebView view, String url) {
            ...
            if (toLoadJs != null) {
                X5BridgeUtil.webViewLoadLocalJs(view, toLoadJs);
            }
    ...
    public void setOnScrollChangedCallback(final BridgeWebView.OnScrollChangedCallback onScrollChangedCallback) {
