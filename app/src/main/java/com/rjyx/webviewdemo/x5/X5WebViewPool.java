...
import com.rjyx.webviewdemo.H5Application;
    ...
    public X5WebView getWebView() {
        synchronized (lock) {
            ...
            if (available.size() > 0) {
                ...
                webView = new X5WebView(H5Application.getInstance());
                inUse.add(webView);
                currentSize++;
            }
            ViewGroup.LayoutParams params = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
