...
import com.rjyx.webviewdemo.widget.X5BridgeWebView;
...
public class X5BridgeWebViewActivity extends AppCompatActivity {
    ...
    private static final String TAG = "X5BridgeWebViewActivity";//日志打印
    private static final String APP_CACAHE_DIRNAME = "/rjyx_webcache";//缓存目录

    private X5BridgeWebView webView;//浏览器控件
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_xfive_bridge_webview);
    ...
    private void intView() {
        webView = (X5BridgeWebView) findViewById(R.id.webView);
